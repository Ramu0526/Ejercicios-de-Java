...
class Ejercicio5 {
    ...
    public static void TomarDatos(){ 
        ...
        System.out.println("y asi saber si esta apto para el ingreso de este mismo señor (36.1 - 37.2 grados).");
        System.out.println(" ");
    ...
    public static void DarResultados(float Temperatura, int Piso){
        if (Piso >= 1 && Piso <= 10){
            System.out.println("Felicidades señor por ser apto con un peso de " + Temperatura + "kg, comenzando a subir al piso " + Piso);
        }
        else{
            System.out.println("La temperatura que ingresaste excede lo permitido, lo siento señor");
